  ...
  return (
    ...
    >
        <div className='flex gap-3 items-center'>
            <FaUserGraduate color="#7289da" size={"24px"} />
            <h2 className='text-base md:text-xl text-[#7289da]'>EDUCATION</h2>
        ...
        <div className="flex gap-5 items-center">
            ...
            <div>
                <h2 className="text-[#7289da] text-base md:text-xl">Desarrollo Web Frontend (React.js) </h2>
        ...
        <div className="flex gap-5 items-center">
            ...
            <div>
                <h2 className="text-[#7289da] text-base md:text-xl">Desarrollo Web</h2>
        ...
        <div className="flex gap-5 items-center">
            ...
            <div className='flex flex-col gap-1'>
                <h2 className="text-[#7289da] text-base md:text-xl">Ingenieria en Informatica</h2>
