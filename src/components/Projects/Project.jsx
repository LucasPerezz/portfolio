...
export default function Project({data}){
    return (
        <motion.article whileHover={{scale: 1.05}} whileTap={{scale: 0.95}} className="relative overflow-hidden rounded-lg cursor-pointer shadow-sm hover:shadow-[#7289da] w-full border border-transparent hover:border-neutral-600">
          <Image
